package pers.haiyang.huluwa.model;

import pers.haiyang.huluwa.util.Sort;
 ...
 * @description：爷爷类，实现对葫芦娃们的排序，实现human接口
 * @modified By：
 * @version: $
 */
public class GrandFather implements human{
    @Override
    public  void sort(List<GourdBaby> list){
